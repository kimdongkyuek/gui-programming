// ==========================================================================
//  v2 - 마우스 클릭 : WM_LBUTTONDOWN
// --------------------------------------------------------------------------
//  [이 단계에서 하는 일]
//    마우스 왼쪽 버튼을 누르면 메시지 박스를 띄웁니다.
//    아직 그림은 그리지 않고, "클릭이 정말 들어오는지"만 눈으로 확인하는 단계입니다.
//
//  [새로 나온 것]
//    WM_LBUTTONDOWN : 마우스 왼쪽 버튼을 누를 때 오는 메시지
//    MessageBox(부모창, 내용, 제목, 버튼종류) : 간단한 알림창
//    L"..."          : 유니코드(넓은 문자) 문자열. Win32 는 기본이 유니코드입니다.
//
//  [실행하면]
//    창 아무 데나 클릭하면 "왼쪽 버튼 클릭" 알림창이 뜹니다.
//    사각형은 v1 그대로 남아 있습니다.
//
//  [바뀐 곳] WM_LBUTTONDOWN 새로 추가
// ==========================================================================
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_LBUTTONDOWN:
        {
            // [설명] 클릭이 여기까지 오는지 확인하는 용도. 실제 그리기는 다음 단계부터.
