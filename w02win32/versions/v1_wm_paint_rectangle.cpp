// ==========================================================================
//  v1 - WndProc에서 WM_PAINT : 사각형 그리기
// --------------------------------------------------------------------------
//  [이 단계에서 하는 일]
//    Visual Studio 기본 템플릿에서 WM_PAINT 안에 사각형 하나를 그립니다.
//    "화면에 뭔가 그리려면 WM_PAINT에서 그린다"는 원칙을 처음 만나는 단계입니다.
//
//  [새로 나온 것]
//    WM_PAINT   : 창을 다시 그려야 할 때 Windows가 보내 주는 메시지
//    HDC        : 그림을 그릴 대상(도화지)을 가리키는 핸들
//    BeginPaint / EndPaint : WM_PAINT 안에서 도화지를 빌리고 돌려주는 짝
//    Rectangle(hdc, left, top, right, bottom) : 사각형 그리기
//
//  [실행하면]
//    창 왼쪽 위에 사각형이 하나 보입니다.
//    창을 가렸다 열거나 크기를 바꿔도 사각형은 그대로 남아 있습니다.
//      -> WM_PAINT 가 그때마다 다시 불려서 다시 그려 주기 때문입니다.
//
//  [바뀐 곳] WM_PAINT
// ==========================================================================
